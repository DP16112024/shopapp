...
export default function RegisterPage() {
  ...
  const handleSubmit = async () => {
    try {
      ...
      login(data); toast.success(`Welcome!`); navigate('/');
  ...
  return (
    <div style={{ maxWidth: 400, margin: '60px auto' }}>
      ...
      <div style={{ background: '#fff', borderRadius: 12, padding: 28, border: '1px solid #e5e5e5' }}>
        ...
        <button onClick={handleSubmit} style={{ background: '#4f46e5', color: '#fff', width: '100%', padding: 12, fontSize: 15 }}>Create Account</button>
